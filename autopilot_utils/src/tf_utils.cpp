...
sensor_msgs::PointCloud2 transformCloud(sensor_msgs::PointCloud2 pc2_in,
  ...
  // transform = tf_buffer.lookupTransform(pc2_in.header.frame_id,target_frame,
  // ros::Time(0));

  try {
    transform = tf_buffer.lookupTransform(target_frame, pc2_in.header.frame_id,
                                          ros::Time(0));
