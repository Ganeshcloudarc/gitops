...
public:
  ...
  void updateHeading(double h) { heading_angle = h; }
  ...
  geometry_msgs::Point
  intersct_point_to_line(const geometry_msgs::Point &point) {
  ...
  vector<double> intersct_point_to_line(const std::vector<double> &v) {
  ...
  double distance_to_point(const std::vector<double> &point) {
