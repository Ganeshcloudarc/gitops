...
class PurePursuitController:
    def __init__(self):
        ...
        self.horn_time = rospy.get_param("/obstacle_stop_planner/horn_time",5) #how long the horn will hong during obstacle detection
        ...
        while not rospy.is_shutdown():
            try:
                ...
                if circum_rad < self.radius_threshold:
                    ...
                    start_horn = time.time()
                    end_time = start_horn + self.horn_time
