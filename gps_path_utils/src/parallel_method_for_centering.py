...
class KmlToMissionFile:
    def __init__(self, kml_file_dir, mission_file_dir): 
        ...
        self.len_of_path = rospy.get_param("len_of_path", 100) 
        ...
        ## over ride the gps values
        self.home_lon,self.home_lat  = 80.000892, 13.593329
        x, y = 0, self.len_of_path
        lat,lon = xy2ll(x,y,self.home_lat,self.home_lon)

        kml_coords = [[self.home_lat,self.home_lon],
                     [lat,lon]]
