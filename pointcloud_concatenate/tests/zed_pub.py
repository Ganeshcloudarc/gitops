...
def main():
    ...
    source_topic = "/zed2i/zed_node/point_cloud/cloud_registered" # rospy.get_param('/source_topic', '/source_pointcloud')  # Default to '/source_pointcloud'
    target_topic = "/zed" # rospy.get_param('/target_topic', '/target_pointcloud')  # Default to '/target_pointcloud'
