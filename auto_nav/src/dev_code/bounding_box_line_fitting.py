...
class BoundingBox_linefitting:
    ...
    def bounding_box_callback(self, bounding_box_msg):
        ...
        for bounding_box_center in bounding_box_centers:
            ...
            if bounding_box_center[1] < 8 and bounding_box_center[1] > 0:
                left_side.append(bounding_box_center)
            elif bounding_box_center[1] > -8 and bounding_box_center[1] < 0:
    ...
    def convert_path(self,path, to_frame):
        ...
        try:
            trans = self.tfBuffer.lookup_transform(to_frame, path.header.frame_id, rospy.Time.now(), rospy.Duration(0.5))
