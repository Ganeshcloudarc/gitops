...
if __name__ == "__main__":
    ...
    source_frame = 'zed2_left_camera_frame'
    target_frame = 'map'

    point_wrt_source = gmsg.Point(34, 0, 0)
    p = [38, 0, 0]
    p =  [1.9124829769134521, 0.3207050859928131, -0.7167167067527771]

    # a = convert_point(point_wrt_source, target_frame, source_frame)
    a = convert_point(point_wrt_source, source_frame, target_frame)


    print(a)
    b = convert_point(p, target_frame, source_frame)
    print(b)
    # print(help(convert_point))

    robot_loc = current_robot_pose(target_frame, source_frame)
